...
export const catalogData = [
    ...
    },
    {
        ...
        image: DairyImage,
        title: 'Ежедневник',
        description: 'Друзья, сегодня хочется поговорить об очень знакомом ощущении когда ты весь день, что-то делал, работал/учился, очень устал, но никаких успешных результатов.',
    },
    {
        id: 3,
        image: HatsImage,
